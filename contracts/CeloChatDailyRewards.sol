...
contract CeloChatDailyRewards {
    ...
    address public constant HC_TOKEN_ADDRESS =
        0x12b6e1f30cb714e8129F6101a7825a910a9982F2;
    uint256 public constant MIN_HC_REQUIRED = 100 * 10 ** 18;

    string public welcomeMessage =
        "Daily CELO reward claimed! Thank you for using Celo Chat!";
    string public cooldownMessage =
        "Please wait 24 hours between claims. Stay active in Celo Chat!";
    string public blacklistMessage =
        "This address cannot claim rewards. Contact Celo Chat support.";
    string public insufficientHCMessage =
        "You need at least 100 HC tokens to claim CELO reward";
    ...
    function claim() external notBlacklisted {
        ...
        require(
            address(this).balance >= DAILY_CELO_REWARD,
            "Insufficient funds"
        );
    ...
    function canClaim(address user) public view returns (bool, string memory) {
        ...
        if (stats.lastClaimTime == 0)
            return (true, "Welcome! Claim your first daily CELO!");
        ...
        if (stats.lastClaimTime == 0) {
            if (userHasEnoughHC) {
                return (
                    ...
                    0,
                    0,
                    "Welcome! Claim your first daily CELO!",
                    userHasEnoughHC
                );
            } else {
                return (
        ...
        )
    {
        ...
        userHasEnoughHC =
            IERC20(HC_TOKEN_ADDRESS).balanceOf(user) >= MIN_HC_REQUIRED;
    }
    ...
    function setInsufficientHCMessage(
